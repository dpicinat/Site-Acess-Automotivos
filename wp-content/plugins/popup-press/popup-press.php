...
add_action('wp_footer', 'add_custom_scripts_PPS', 123 );
...
function add_scripts_PPS() {
	...
	wp_register_script( 'pps_bPopup', PPS_URL.'/js/libs/bpopup.js', array('jquery'), '0.10', true );
	...
	wp_register_script( 'pps_popupslider', PPS_URL.'/js/libs/jquery.popupslider.js', array('jquery'), '2.5.0', true );
	wp_enqueue_script( 'pps_popupslider' );

	// Plugin jQuery - jQuery Cookies
	wp_register_script( 'pps_jCookie', PPS_URL.'/js/libs/jquery.cookie.js', array('jquery'), '1.4.1', true );
	wp_enqueue_script( 'pps_jCookie' );

	// Plugin jQuery - Easing
	wp_register_script( 'pps_easing', PPS_URL.'/js/libs/jquery.easing.1.3.js', array('jquery'), '1.3', true );
	wp_enqueue_script( 'pps_easing' );

	// Añadimos el Script JS Principal
	wp_register_script( 'pps_js_script', PPS_URL.'/js/pps_script.js', array('jquery'), PPS_VERSION, true );
